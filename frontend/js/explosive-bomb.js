...
class ExplosiveBomb extends Entity {
    ...
    startExplosion() {
        ...
        console.log(`Bomb exploding at (${Math.round(this.x)}, ${Math.round(this.y)})`);
    }
    ...
    updateExplosion(deltaTime) {
        ...
        if (this.explosionTimer < this.explosionDuration) {
            ...
            if (Math.floor(this.explosionTimer * 10) !== Math.floor((this.explosionTimer - deltaTime) * 10)) {
        ...
        // console.log(`Explosion progress: ${Math.round(progress * 100)}%, radius: ${Math.round(this.explosionRadius)}px`);
            ...
            console.log(`Explosion completed, destroying bomb`);
            this.destroy();
        }
    }
    ...
    renderExplosion(ctx) {
        ...
        console.log(`Drawing explosion at (${centerX}, ${centerY}) with radius ${this.explosionRadius}`);
