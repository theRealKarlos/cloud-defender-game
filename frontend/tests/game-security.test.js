...
describe('GameSecurity', () => {
    ...
    describe('Event Recording Methods', () => {
        ...
        test('should record wave completion events', () => {
            ...
            const waveEvent = gameSecurity.gameEvents.find(e => e.type === 'wave_complete');
        ...
        test('should record missile destruction events', () => {
            ...
            const missileEvent = gameSecurity.gameEvents.find(e => e.type === 'missile_destroyed');
        ...
        test('should record target hit events', () => {
            ...
            const targetEvent = gameSecurity.gameEvents.find(e => e.type === 'target_hit');
        ...
        test('should record game over and return validation', () => {
            ...
            const gameOverEvent = gameSecurity.gameEvents.find(e => e.type === 'game_over');
