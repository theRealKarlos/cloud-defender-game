...
describe('Score Handler', () => {
    ...
    describe('submitScore', () => {
        ...
        test('should successfully submit a valid score', async () => {
            ...
            expect(mockScoreValidator.validateScore).toHaveBeenCalledWith(validScoreData);
        ...
        test('should handle database errors gracefully', async () => {
            ...
            dbService.saveScore.mockRejectedValue(new Error('Database connection failed'));
            
            const result = await submitScore(validScoreData);
            
            expect(apiResponses.internalError).toHaveBeenCalledWith('Failed to submit score');
    ...
    describe('getLeaderboard', () => {
        ...
        test('should handle database errors gracefully', async () => {
            ...
            expect(apiResponses.internalError).toHaveBeenCalledWith('Failed to fetch leaderboard');
            expect(result.statusCode).toBe(500);
        });
