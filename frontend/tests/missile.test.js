...
describe('Missile Class', () => {
    ...
    describe('Initialisation', () => {
        ...
        test('should set initial velocity based on trajectory and speed', () => {
            const expectedVelX = missile.trajectory.directionX * missile.speed;
            const expectedVelY = missile.trajectory.directionY * missile.speed;
    ...
    describe('Movement Algorithms', () => {
        ...
        test('should apply acceleration based on missile type', () => {
            ...
            const initialCostSpeed = Math.sqrt(costSpike.velocityX ** 2 + costSpike.velocityY ** 2);
            const initialGhostSpeed = Math.sqrt(latencyGhost.velocityX ** 2 + latencyGhost.velocityY ** 2);
            
            costSpike.updateMovement(0.1);
            latencyGhost.updateMovement(0.1);
            
            const finalCostSpeed = Math.sqrt(costSpike.velocityX ** 2 + costSpike.velocityY ** 2);
            const finalGhostSpeed = Math.sqrt(latencyGhost.velocityX ** 2 + latencyGhost.velocityY ** 2);
            
            // Cost spike should accelerate (1.2x), latency ghost should decelerate (0.9x)
            expect(finalCostSpeed).toBeGreaterThan(initialCostSpeed);
            expect(finalGhostSpeed).toBeLessThan(initialGhostSpeed);
        });
    });
    ...
    describe('Target Detection', () => {
        ...
        test('should detect when target is reached', () => {
            // Position missile very close to target
            missile.x = targetX - 5;
            missile.y = targetY - 5;
    ...
    describe('Lifecycle Management', () => {
        ...
        test('should update rotation based on movement direction', () => {
            const expectedRotation = Math.atan2(missile.velocityY, missile.velocityX) + Math.PI / 2;
    ...
    describe('Factory Methods', () => {
        ...
        test('should create random missile types', () => {
            ...
            expect(['cost-spike', 'data-breach', 'latency-ghost', 'policy-violator'])
