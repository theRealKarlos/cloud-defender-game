...
describe('Defense Class', () => {
    ...
    describe('Target Detection', () => {
        ...
        test('should find targets within range', () => {
            const mockMissile1 = {
                ...
                active: true,
                x: 120, y: 220, width: 16, height: 20,
                damage: 25,
                velocityX: 50, velocityY: 30,
                type: 'cost-spike',
            ...
            const mockMissile2 = {
                collisionLayer: 'missiles',
                active: true,
                x: 300, y: 400, width: 16, height: 20,
                damage: 30,
                velocityX: 40, velocityY: 20,
                type: 'data-breach',
                getBounds: () => ({ centerX: 308, centerY: 410 })
            };
            
            // Mock distanceTo method
            defense.distanceTo = jest.fn()
        ...
        test('should ignore non-missile entities', () => {
            const mockTarget = {
                ...
                active: true,
                x: 120, y: 220, width: 48, height: 48,
    ...
    describe('Cooldown and Charging Updates', () => {
        ...
        test('should regenerate shield energy over time', () => {
            ...
            expect(shieldNode.shieldEnergy).toBeLessThanOrEqual(shieldNode.maxShieldEnergy);
        });
...
describe('DefenseProjectile Class', () => {
    ...
    beforeEach(() => {
        ...
        projectile = new DefenseProjectile(
            'firewall',
            50, 100,    // start position
            150, 200,   // target position
            30,         // damage
            300,        // speed
    ...
    describe('Initialisation', () => {
        ...
        test('should set rotation based on movement direction', () => {
            const expectedRotation = Math.atan2(projectile.velocityY, projectile.velocityX);
